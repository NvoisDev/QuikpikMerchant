...
- **Delivery Cost Capture Fix (Aug 2025)**: Resolved critical issue where delivery costs weren't being captured in order totals. Fixed payment intent creation to include shipping costs in customer charges and updated order processor to properly calculate total including subtotal + shipping + transaction fee. Order SF-155 corrected from £1,277.05 to £1,367.05 (adding missing £90.00 delivery cost). All future orders now properly capture and store delivery costs.
