...
The Quikpik Team
  ...
  app.get('/api/shipping/tracked-orders', requireAuth, async (req: any, res) => {
    try {
      ...
      // Filter orders that have shipping tracking
      let trackedOrders = orders
      ...
      // If no tracked orders exist, provide demo data for demonstration purposes
      if (trackedOrders.length === 0) {
        const demoOrders = [
          ...
          },
          {
            ...
            lastUpdated: '2025-07-30T07:20:00Z',
            events: []
          },
          {
            id: 152,
