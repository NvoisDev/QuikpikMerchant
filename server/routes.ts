...
<body>
  ...
  app.post('/api/webhooks/stripe', async (req, res) => {
    ...
    console.log(`🔔 [${timestamp}] Webhook: ${event.type}`);
    ...
    switch (event.type) {
      ...
      // Current system uses Checkout Sessions + payment_intent.succeeded pattern

      // Note: invoice.* and customer.subscription.* events are not needed
      // Current system uses payment_intent.succeeded for subscription upgrades
