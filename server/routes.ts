...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  */
  ...
  const ctx = {
    ...
    requireAuth, isAuthenticated, z, requireNotViewer,
    requireFeatureAccess, requireProductLimits, requireBroadcastLimits, requireTeamMemberLimits, getUserPlanLimits,
    stripe, openai, sgMail, twilio, parcel2goService, whatsAppBusinessService,
    SubscriptionService, ReliableSMSService, sendSMS, sendEmail,
    PLAN_ENFORCEMENT_LIMITS, enforceNewPlanLimits, getProjectedDowngradeImpact,
    getProductLimit, getCustomerGroupLimit, getBroadcastLimit, getCustomersPerGroupLimit, getTeamMemberLimit,
    orderPhotoUpload, sendCustomerInvoiceEmail, createStripeRefundReceipt,
    sendRefundReceipt, generateOrderNotificationMessage, buildInvoicePdf,
    ...
    InventoryCalculator, PreciseShippingCalculator, healthCheck,
    ...
    isInvitationExpired, sendWelcomeEmail, passwordResetAttempts, ADMIN_EMAILS, geocodePostcode,
  ...
  registerCustomerAuthRoutes(app, ctx);
  ...
  registerAdvertisingRoutes(app, ctx);
