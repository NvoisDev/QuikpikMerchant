...
const UPGRADE_PLANS_CARD = emailCard(
  ...
  '<li>5 products</li><li>Broadcast tools coming soon</li><li>3 team members</li><li>5 customer groups</li></ul>' +
  '</div></td>' +
...
export function generateDowngradeScheduledEmail(data: DowngradeScheduledEmailData): { subject: string; html: string; text: string } {
  ...
  const currentFeaturesText = data.currentPlan === 'premium'
    ...
    : 'Current Standard features: 5 products, broadcast tools coming soon, 3 team members, 5 customer groups.';
  ...
  const text =
    ...
    currentFeaturesText + '\n\n' +
    'Free plan limits: 2 products, broadcast tools coming soon, 1 team member, 2 customer groups.\n\n' +
...
export function generateDowngradeEffectiveEmail(data: DowngradeEffectiveEmailData): { subject: string; html: string; text: string } {
  ...
  const text =
    ...
    'Standard: \u00A319.99/mo — 5 products, broadcast tools coming soon, 3 team members\n' +
