...
import { calculateCustomerFee, calculatePlatformFee, CUSTOMER_FEE_RATE, CUSTOMER_FEE_FIXED, PLATFORM_FEE_RATE } from '../shared/utils/fees';
...
describe('calculatePlatformFee', () => {
  it('calculates the platform fee for a typical subtotal', () => {
    ...
    expect(fee).toBeCloseTo(100 * PLATFORM_FEE_RATE, 10);
  });
  ...
  it('scales linearly with larger subtotals', () => {
    ...
    expect(fee).toBeCloseTo(500 * PLATFORM_FEE_RATE, 10);
  });
