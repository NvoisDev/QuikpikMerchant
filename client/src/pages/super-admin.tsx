        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <Card className="border-gray-200 shadow-none rounded-xl">
                ...
                <CardContent className="px-4 pb-4 space-y-2.5">
                  ...
                  <Row label="Merchant fees (4.6%)"         value={fmt(revenueTotals.totalPlatformFees)}  color={AMBER} />
          ...
          <TabsContent value="revenue" className="space-y-4">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
              ...
              <StatCard label="Merchant Fees" value={fmt(revenueTotals.totalPlatformFees)}  sub="4.6% per order"         icon={<TrendingUp className="h-4 w-4" />}   color={AMBER} />
