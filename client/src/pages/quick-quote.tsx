...
function getCustomerInitials(c: { firstName?: string | null; lastName?: string | null; businessName?: string | null; phoneNumber?: string | null }) {
  if (c.businessName) return c.businessName.slice(0, 2).toUpperCase();
  if (c.firstName) return `${c.firstName[0]}${c.lastName ? c.lastName[0] : ''}`.toUpperCase();
  if (c.phoneNumber) return c.phoneNumber.replace(/\D/g, '').slice(-2);
  return '?';
}
          ...
          <Card>
            ...
            <CardContent>
              ...
              >
                ...
                <SheetContent side="bottom" className="h-[100dvh] max-h-[100dvh] rounded-none flex flex-col p-0">
