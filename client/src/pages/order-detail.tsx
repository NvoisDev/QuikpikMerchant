              ...
              return (
                <div className="border-t pt-3 space-y-3">
                  <div className="grid grid-cols-2 gap-2 text-xs">
                    ...
                    {order.paymentStatus === 'paid' && !order.cancelledAt && order.status !== 'cancelled' && Math.round((amountPaidRaw - parseFloat(order.amountRefunded || '0')) * 100) < Math.round(parseFloat(order.total || '0') * 100) && (
