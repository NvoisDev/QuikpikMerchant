              ...
              <div className="space-y-6">
                <div className="flex flex-col sm:flex-row gap-4 sm:items-start">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 text-sm mt-2">Accept secure card payments and route funds directly to your connected bank account. Payments are processed on your behalf with a 5% platform fee.</p>
                  </div>
                </div>
                <div className="grid grid-cols-3 gap-4 bg-gray-50 rounded-xl p-4 text-center">
                  <div><p className="text-sm font-semibold text-gray-800">5%</p><p className="text-xs text-gray-500 mt-0.5">Platform fee</p></div>
